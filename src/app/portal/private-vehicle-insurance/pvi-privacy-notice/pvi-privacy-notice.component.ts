...
@Component({
  selector: 'app-pvi-privacy-notice',
  templateUrl: './pvi-privacy-notice.component.html',
  styleUrls: ['./pvi-privacy-notice.component.css']
})
export class PviPrivacyNoticeComponent {
  journey = ''
